# Generated by Django 2.1.3 on 2018-11-13 19:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server_type', models.CharField(choices=[('BIND9', 'bind9')], default='bind9', editable=False, max_length=8, verbose_name='Type server')),
            ],
        ),
        migrations.CreateModel(
            name='Zone',
            fields=[
                ...
                ('zone_type', models.CharField(choices=[('FWD', 'forward'), ('RVS', 'reverse')], default='forward', max_length=8, verbose_name='Type zone')),
